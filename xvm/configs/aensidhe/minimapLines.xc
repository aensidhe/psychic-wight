 ...
 */
{
  "lines": {
       ...
       "vehicle": [
         { "enabled": true, "from": 50,  "to": 95,   "inmeters": true, "thickness": 1.5,  "alpha": 45, "color": "0xFFCC66"},
         { "enabled": true, "from": 100, "to": 145,  "inmeters": true, "thickness": 1.4,  "alpha": 40, "color": "0xFFCC66"},
         { "enabled": true, "from": 150, "to": 196,  "inmeters": true, "thickness": 1.3,  "alpha": 35, "color": "0xFFCC66"},
         { "enabled": true, "from": 200, "to": 246,  "inmeters": true, "thickness": 1.2,  "alpha": 33, "color": "0xFFCC66"},
         { "enabled": true, "from": 250, "to": 296,  "inmeters": true, "thickness": 1.1,  "alpha": 30, "color": "0xFFCC66"},
         { "enabled": true, "from": 300, "to": 397,  "inmeters": true, "thickness": 1,    "alpha": 30, "color": "0xFFCC66"},
         { "enabled": true, "from": 400, "to": 497,  "inmeters": true, "thickness": 0.9,  "alpha": 30, "color": "0xFFCC66"},
         { "enabled": true, "from": 500, "to": 2000, "inmeters": true, "thickness": 0.75, "alpha": 30, "color": "0xFFCC66"}
       ],
       // Camera direction.
