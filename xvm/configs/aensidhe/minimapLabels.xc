  ...
  "labels": {
      ...
      "units": {
        ...
        "css": {
          ...
          "enemy":           ".mm_e{font-family:$FieldFont; font-size:4px; color:#FCA9A4;}",
          "squad":           ".mm_s{font-family:$FieldFont; font-size:4px; color:#FFD099;}",
          "oneself":         ".mm_o{font-family:$FieldFont; font-size:4px; color:#FFFFFF;}",
          "lostally":       ".mm_la{font-family:$FieldFont; font-size:4px; color:#C8FFA6;} .mm_dot{font-family:Arial; font-size:4px; color:#B4E595;}",
          "lostteamkiller": ".mm_lt{font-family:$FieldFont; font-size:4px; color:#A6F8FF;} .mm_dot{font-family:Arial; font-size:4px; color:#00D2E5;}",
          "lost":            ".mm_l{font-family:$FieldFont; font-size:4px; color:#FCA9A4;} .mm_dot{font-family:Arial; font-size:4px; color:#E59995;}",
          "lostsquad":      ".mm_ls{font-family:$FieldFont; font-size:4px; color:#FFD099;} .mm_dot{font-family:Arial; font-size:4px; color:#E5BB8A;}",
          "deadally":       ".mm_da{font-family:$FieldFont; font-size:4px; color:#6E8C5B;} .mm_dot{font-family:Arial; font-size:4px; color:#004D00;}",
          "deadteamkiller": ".mm_dt{font-family:$FieldFont; font-size:4px; color:#5B898C;} .mm_dot{font-family:Arial; font-size:4px; color:#043A40;}",
          "deadenemy":      ".mm_de{font-family:$FieldFont; font-size:4px; color:#996763;} .mm_dot{font-family:Arial; font-size:4px; color:#4D0300;}",
          "deadsquad":      ".mm_ds{font-family:$FieldFont; font-size:4px; color:#997C5C;} .mm_dot{font-family:Arial; font-size:4px; color:#663800;}"
        },
        // Fields shadow.
        // Тени полей.
