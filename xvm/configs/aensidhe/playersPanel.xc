 ...
 */
{
  "playersPanel": {
    ...
    "large": {
      ...
      "nickFormatLeft": "<font face='Consolas' size='12' color='{{c:rating}}'>{{rating%3d~%}}</font> <font face='Consolas' size='12' color='{{c:xwn8}}'>{{nick}}</font>",
      "nickFormatRight": "<font face='Consolas' size='12' color='{{c:xwn8}}'>{{nick}}</font> <font face='Consolas' size='12' color='{{c:rating}}'>{{rating%3d~%}}</font>",
